...
Every set type may has different create options, visit [SetType](https://pkg.go.dev/github.com/kiyonlin/gonetx/ipset?tab=doc#SetType) and [Option](https://pkg.go.dev/github.com/kiyonlin/gonetx/ipset?tab=doc#Option) for more details.
